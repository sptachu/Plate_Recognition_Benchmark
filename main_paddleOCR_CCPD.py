...
def postprocess_plate(raw_text, target_len=5):
    ...
    1 Letter + 5 Alphanumerics (No 'I' or 'O' allowed in the alphanumeric part).
    """
    # 1. Strip any accidental whitespace or symbols
    ...
    # Dictionary to fix numbers mistaken as letters at Index 0 (City Code)
    num_to_let = {'8': 'B', '0': 'D', '1': 'T', '2': 'Z', '5': 'S'}
    
    # Dictionary to fix forbidden letters in the remaining string
    forbidden_to_num = {'I': '1', 'O': '0'} 

    # if len(char_list) > 0:
    #     # Force Index 0 to be a letter
    #     if char_list[0] in num_to_let:
    #         char_list[0] = num_to_let[char_list[0]]
            
    # Force remaining indices to obey the no 'I' / 'O' rule
    ...
    for rel_path in test_images:
        ...
        for result in results:
            for box in result.boxes:
                ...
                # Ręczne wymuszenie proporcji i rozdzielczości wejściowej dla silnika PaddleOCR
                ...
                # Apply formatting and heuristic corrections
